    ...
    <section id="hero" className="relative isolate overflow-hidden pt-28 pb-20 text-white">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 md:px-6">
        <div className="flex max-w-3xl flex-col gap-6">
          <p className="font-display text-sm uppercase tracking-[0.3em] text-accent">Brew Brava</p>
          <h1 className="font-display text-4xl leading-tight sm:text-5xl md:text-6xl">
            Brew Brava — Крафтовое пиво, Нячанг
          </h1>
          <p className="max-w-2xl text-lg text-gray-200">
            Крафтовое пиво с характером. Сварено с душой у моря.
          </p>
